...
export default function Page() {
  return (
    <div className="prose prose-sm prose-invert max-w-none">
      ...
      <ul>
        <li>
          This example uses Route Groups to create layouts for
          different sections of the app without affecting the URL
          structure.
        </li>
        <li>
          Try navigating pages and noting the different layouts used
          for each section.
        </li>
        ...
        <ul>
          ...
          <li>
            Create multiple root layouts by partitioning the top level
            of the application.
          </li>
        </ul>
      </ul>
