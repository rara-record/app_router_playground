...
export default function AddToCart({
  ...
  return (
    <button
      className="
      relative w-full item-center space-x-2 rounded-lg bg-vercel-blue px-3 py-1 text-sm font-medium
     text-white hover:bg-vercel-blue/90 disabled:text-white/70"
      onClick={addToCart}
      disabled={isPending}
    >
      Add to Cart
